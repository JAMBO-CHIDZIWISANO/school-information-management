...
Mark.findMarkById = (markId, result) => {
  ...
  Mark.updateMarkById = (markId, mark, result) => {
    ...
    sql.query(
      "UPDATE student_marks SET studentId=?, student_score = ?, total_score = ?, termId = ?, type=? WHERE markId = ?",
